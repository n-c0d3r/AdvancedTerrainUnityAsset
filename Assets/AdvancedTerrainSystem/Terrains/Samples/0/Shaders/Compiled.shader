Shader "HDRPTerrain_cbd4836366574a41b6cfdcd7333917cd"
{
    Properties
    {
        BaseColor_0("BaseColor_0",Color) = (0,0,0,0)
AlbedoMap_0("AlbedoMap_0",2D) = "" {}
NormalMap_0("NormalMap_0",2D) = "" {}
NormalStrength_0("NormalStrength_0",Float) = 0
RouchMap_0("RouchMap_0",2D) = "" {}
RouchIntensity_0("RouchIntensity_0",Float) = 0
DisplacementMap_0("DisplacementMap_0",2D) = "" {}
DisplacementAmplitude_0("DisplacementAmplitude_0",Float) = 0
DisplacementOffset_0("DisplacementOffset_0",Float) = 0
SizeAndOffset_0("SizeAndOffset_0",Vector) = (0,0,0,0)
SmoothBlend_0("SmoothBlend_0",Float) = 0
BaseColor_1("BaseColor_1",Color) = (0,0,0,0)
AlbedoMap_1("AlbedoMap_1",2D) = "" {}
NormalMap_1("NormalMap_1",2D) = "" {}
NormalStrength_1("NormalStrength_1",Float) = 0
RouchMap_1("RouchMap_1",2D) = "" {}
RouchIntensity_1("RouchIntensity_1",Float) = 0
DisplacementMap_1("DisplacementMap_1",2D) = "" {}
DisplacementAmplitude_1("DisplacementAmplitude_1",Float) = 0
DisplacementOffset_1("DisplacementOffset_1",Float) = 0
SizeAndOffset_1("SizeAndOffset_1",Vector) = (0,0,0,0)
SmoothBlend_1("SmoothBlend_1",Float) = 0
BaseColor_2("BaseColor_2",Color) = (0,0,0,0)
AlbedoMap_2("AlbedoMap_2",2D) = "" {}
NormalMap_2("NormalMap_2",2D) = "" {}
NormalStrength_2("NormalStrength_2",Float) = 0
RouchMap_2("RouchMap_2",2D) = "" {}
RouchIntensity_2("RouchIntensity_2",Float) = 0
DisplacementMap_2("DisplacementMap_2",2D) = "" {}
DisplacementAmplitude_2("DisplacementAmplitude_2",Float) = 0
DisplacementOffset_2("DisplacementOffset_2",Float) = 0
SizeAndOffset_2("SizeAndOffset_2",Vector) = (0,0,0,0)
SmoothBlend_2("SmoothBlend_2",Float) = 0
SpeedX_2("SpeedX_2",Float) = 0
SpeedY_2("SpeedY_2",Float) = 0
ALPHAMAP_0("ALPHAMAP_0",2D) = "" {}
        ...
        [HideInInspector][Enum(None, 0, Phong, 1)]_TessellationMode("Float", Float) = 0
...
float NormalStrength_0;
Texture2D RouchMap_0;
float RouchIntensity_0;
Texture2D DisplacementMap_0;
float DisplacementAmplitude_0;
float DisplacementOffset_0;
float4 SizeAndOffset_0;
float SmoothBlend_0;
float4 BaseColor_1;
Texture2D AlbedoMap_1;
Texture2D NormalMap_1;
float NormalStrength_1;
Texture2D RouchMap_1;
float RouchIntensity_1;
Texture2D DisplacementMap_1;
float DisplacementAmplitude_1;
float DisplacementOffset_1;
float4 SizeAndOffset_1;
float SmoothBlend_1;
float4 BaseColor_2;
Texture2D AlbedoMap_2;
Texture2D NormalMap_2;
float NormalStrength_2;
Texture2D RouchMap_2;
float RouchIntensity_2;
Texture2D DisplacementMap_2;
float DisplacementAmplitude_2;
float DisplacementOffset_2;
float4 SizeAndOffset_2;
float SmoothBlend_2;
float SpeedX_2;
float SpeedY_2;
Texture2D ALPHAMAP_0;
...
#include "Assets/AdvancedTerrainSystem/Terrains/Default/Layers/LitLayer.hlsl.COMPILED0.hlsl"
#include "Assets/AdvancedTerrainSystem/Terrains/Default/Layers/LitLayer.hlsl.COMPILED1.hlsl"
#include "Assets/AdvancedTerrainSystem/Terrains/Samples/0/Layers/DemoLayer.hlsl.COMPILED2.hlsl"
...
void TerrainFragment_float(float3 PositionIn, float3 NormalIn, float4 UVIn, float3 TangentIn, out float3 BaseColorOut, out float3 NormalOut, out float3 BentNormalOut, out float MetallicOut, out float3 EmissionOut, out float SmoothnessOut, out float AmbientOcclusionOut, out float AlphaOut) {
        ...
        float DisplacementOut = -100.0f;
                    ...
                    float3 BaseColorOut_0 = float3(0,0,0);
                    float3 NormalOut_0 = float3(0,0,0);
                    float3 BentNormalOut_0 = float3(0,0,0);
                    float MetallicOut_0 = 0;
                    float3 EmissionOut_0 = float3(0,0,0); 
                    float SmoothnessOut_0 = 0; 
                    float AmbientOcclusionOut_0 = 0; 
                    float AlphaOut_0 = 0;
                    float DisplacementOut_0 = 0;
                    float SmoothBlendOut_0 = 0;

                    float Alpha_0 = SAMPLE_TEXTURE2D(ALPHAMAP_0, SamplerState_Linear_Repeat, UV).x;
                
FRAGMENT_SHADER_0(Alpha_0, PositionIn,NormalIn,UVIn,TangentIn,BaseColorOut_0,NormalOut_0,BentNormalOut_0,MetallicOut_0,EmissionOut_0,SmoothnessOut_0,AmbientOcclusionOut_0,AlphaOut_0,DisplacementOut_0,SmoothBlendOut_0);
	

                        {

                            BaseColorOut = BaseColorOut_0;
                            NormalOut = NormalOut_0;
                            BentNormalOut = BentNormalOut_0;
                            MetallicOut = MetallicOut_0;
                            EmissionOut = EmissionOut_0;
                            SmoothnessOut = SmoothnessOut_0;
                            AmbientOcclusionOut = AmbientOcclusionOut_0;
                            AlphaOut = AlphaOut_0;

                            DisplacementOut = DisplacementOut_0;

                        }
                    	
                    float3 BaseColorOut_1 = float3(0,0,0);
                    float3 NormalOut_1 = float3(0,0,0);
                    float3 BentNormalOut_1 = float3(0,0,0);
                    float MetallicOut_1 = 0;
                    float3 EmissionOut_1 = float3(0,0,0); 
                    float SmoothnessOut_1 = 0; 
                    float AmbientOcclusionOut_1 = 0; 
                    float AlphaOut_1 = 0;
                    float DisplacementOut_1 = 0;
                    float SmoothBlendOut_1 = 0;

                    float Alpha_1 = SAMPLE_TEXTURE2D(ALPHAMAP_0, SamplerState_Linear_Repeat, UV).y;
                
FRAGMENT_SHADER_1(Alpha_1, PositionIn,NormalIn,UVIn,TangentIn,BaseColorOut_1,NormalOut_1,BentNormalOut_1,MetallicOut_1,EmissionOut_1,SmoothnessOut_1,AmbientOcclusionOut_1,AlphaOut_1,DisplacementOut_1,SmoothBlendOut_1);
...

                        {
                            ...
                            float3 BaseColorSmoothBlend = lerp(BaseColorOut, BaseColorOut_1, Alpha);
                            float3 NormalSmoothBlend = normalize(lerp(NormalOut, NormalOut_1, Alpha));
                            float3 BentNormalSmoothBlend = lerp(BentNormalOut, BentNormalOut_1, Alpha);
                            float MetallicSmoothBlend = lerp(MetallicOut, MetallicOut_1, Alpha);
                            float3 EmissionSmoothBlend = lerp(EmissionOut, EmissionOut_1, Alpha); 
                            float SmoothnessSmoothBlend = lerp(SmoothnessOut, SmoothnessOut_1, Alpha); 
                            float AmbientOcclusionSmoothBlend = lerp(AmbientOcclusionOut, AmbientOcclusionOut_1, Alpha); 
                            float AlphaSmoothBlend = lerp(AlphaOut, AlphaOut_1, Alpha);
                            ...
                            if(DisplacementOut <= DisplacementOut_1){

                                BaseColorHardBlend = BaseColorOut_1;
                                NormalHardBlend = normalize(NormalOut_1);
                                BentNormalHardBlend = BentNormalOut_1;
                                MetallicHardBlend = MetallicOut_1;
                                EmissionHardBlend = EmissionOut_1;
                                SmoothnessHardBlend = SmoothnessOut_1;
                                AmbientOcclusionHardBlend = AmbientOcclusionOut_1;
                                AlphaHardBlend = AlphaOut_1;

                                DisplacementOut = DisplacementOut_1;

                            }



                            SmoothBlendOut_1 = lerp(SmoothBlendOut_0, SmoothBlendOut_1, Alpha_1);



                            BaseColorOut = lerp( BaseColorHardBlend, BaseColorSmoothBlend, SmoothBlendOut_1);
                            
                            //BaseColorOut = lerp(SmoothBlendOut_0, SmoothBlendOut_1, Alpha_1)*float3(1,1,1);
                            //BaseColorOut = SmoothBlendOut_0*float3(1,1,1);

NormalOut = normalize(lerp( NormalHardBlend, NormalSmoothBlend, SmoothBlendOut_1));
                            BentNormalOut = lerp( BentNormalHardBlend, BentNormalSmoothBlend, SmoothBlendOut_1);
                            MetallicOut = lerp( MetallicHardBlend, MetallicSmoothBlend, SmoothBlendOut_1);
                            EmissionOut = lerp( EmissionHardBlend, EmissionSmoothBlend, SmoothBlendOut_1); 
                            SmoothnessOut = lerp( SmoothnessHardBlend, SmoothnessSmoothBlend, SmoothBlendOut_1); 
                            AmbientOcclusionOut = lerp( AmbientOcclusionHardBlend, AmbientOcclusionSmoothBlend, SmoothBlendOut_1); 
                            AlphaOut = lerp( AlphaHardBlend, AlphaSmoothBlend, SmoothBlendOut_1);

                        }
                    	
                    float3 BaseColorOut_2 = float3(0,0,0);
                    float3 NormalOut_2 = float3(0,0,0);
                    float3 BentNormalOut_2 = float3(0,0,0);
                    float MetallicOut_2 = 0;
                    float3 EmissionOut_2 = float3(0,0,0); 
                    float SmoothnessOut_2 = 0; 
                    float AmbientOcclusionOut_2 = 0; 
                    float AlphaOut_2 = 0;
                    float DisplacementOut_2 = 0;
                    float SmoothBlendOut_2 = 0;

                    float Alpha_2 = SAMPLE_TEXTURE2D(ALPHAMAP_0, SamplerState_Linear_Repeat, UV).z;
                
FRAGMENT_SHADER_2(Alpha_2, PositionIn,NormalIn,UVIn,TangentIn,BaseColorOut_2,NormalOut_2,BentNormalOut_2,MetallicOut_2,EmissionOut_2,SmoothnessOut_2,AmbientOcclusionOut_2,AlphaOut_2,DisplacementOut_2,SmoothBlendOut_2);
...

                        {
                            ...
                            float3 BaseColorSmoothBlend = lerp(BaseColorOut, BaseColorOut_2, Alpha);
                            float3 NormalSmoothBlend = normalize(lerp(NormalOut, NormalOut_2, Alpha));
                            float3 BentNormalSmoothBlend = lerp(BentNormalOut, BentNormalOut_2, Alpha);
                            float MetallicSmoothBlend = lerp(MetallicOut, MetallicOut_2, Alpha);
                            float3 EmissionSmoothBlend = lerp(EmissionOut, EmissionOut_2, Alpha); 
                            float SmoothnessSmoothBlend = lerp(SmoothnessOut, SmoothnessOut_2, Alpha); 
                            float AmbientOcclusionSmoothBlend = lerp(AmbientOcclusionOut, AmbientOcclusionOut_2, Alpha); 
                            float AlphaSmoothBlend = lerp(AlphaOut, AlphaOut_2, Alpha);
                            ...
                            if(DisplacementOut <= DisplacementOut_2){

                                BaseColorHardBlend = BaseColorOut_2;
                                NormalHardBlend = normalize(NormalOut_2);
                                BentNormalHardBlend = BentNormalOut_2;
                                MetallicHardBlend = MetallicOut_2;
                                EmissionHardBlend = EmissionOut_2;
                                SmoothnessHardBlend = SmoothnessOut_2;
                                AmbientOcclusionHardBlend = AmbientOcclusionOut_2;
                                AlphaHardBlend = AlphaOut_2;

                                DisplacementOut = DisplacementOut_2;

                            }



                            SmoothBlendOut_2 = lerp(SmoothBlendOut_1, SmoothBlendOut_2, Alpha_2);



                            BaseColorOut = lerp( BaseColorHardBlend, BaseColorSmoothBlend, SmoothBlendOut_2);
                            
                            //BaseColorOut = lerp(SmoothBlendOut_1, SmoothBlendOut_2, Alpha_2)*float3(1,1,1);
                            //BaseColorOut = SmoothBlendOut_0*float3(1,1,1);

NormalOut = normalize(lerp( NormalHardBlend, NormalSmoothBlend, SmoothBlendOut_2));
                            BentNormalOut = lerp( BentNormalHardBlend, BentNormalSmoothBlend, SmoothBlendOut_2);
                            MetallicOut = lerp( MetallicHardBlend, MetallicSmoothBlend, SmoothBlendOut_2);
                            EmissionOut = lerp( EmissionHardBlend, EmissionSmoothBlend, SmoothBlendOut_2); 
                            SmoothnessOut = lerp( SmoothnessHardBlend, SmoothnessSmoothBlend, SmoothBlendOut_2); 
                            AmbientOcclusionOut = lerp( AmbientOcclusionHardBlend, AmbientOcclusionSmoothBlend, SmoothBlendOut_2); 
                            AlphaOut = lerp( AlphaHardBlend, AlphaSmoothBlend, SmoothBlendOut_2);
...
VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
{
    ...
    description.TessellationFactor = 1;
    description.TessellationDisplacement = float3 (0, 0, 0);
    return description;
}
...
SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
{
    ...
    float4 _UV_afb6075dee81421fbe55b5c5420a81f7_Out_0 = IN.uv0;
    float3 _TerrainFragmentCustomFunction_6ae1e2e243a3486e80193448e1e8c91a_BaseColorOut_0;
    float3 _TerrainFragmentCustomFunction_6ae1e2e243a3486e80193448e1e8c91a_NormalOut_1;
    float3 _TerrainFragmentCustomFunction_6ae1e2e243a3486e80193448e1e8c91a_BentNormalOut_2;
    float _TerrainFragmentCustomFunction_6ae1e2e243a3486e80193448e1e8c91a_MetallicOut_3;
...
SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
{
    ...
    surface.Metallic = _TerrainFragmentCustomFunction_6ae1e2e243a3486e80193448e1e8c91a_MetallicOut_3;
    return surface;
}
